...
# Database configuration for AL
DATABASE_NAME = "Bishop_State_Community_College"
DB_ACRONYM = "AL"
DB_FULL_NAME = "Bishop State Community College"

@router.get("/", response_model=DatabaseInfo)
async def get_database_info():
    """Get information about AL database."""
    return DatabaseInfo(
        acronym=DB_ACRONYM,
...
async def get_cohorts(
    ...
    """Get cohort records from AL database."""
    try:
...
async def get_courses(
    ...
    """Get course records from AL database."""
    try:
        with get_db_connection(DATABASE_NAME) as connection:
            cursor = connection.cursor(dictionary=True)
...
async def get_financial_aid(
    ...
    """Get financial aid records from AL database."""
    try:
        with get_db_connection(DATABASE_NAME) as connection:
            cursor = connection.cursor(dictionary=True)
